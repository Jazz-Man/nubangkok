var config = {
    map: {
        '*': {
            'Eadesigndev_RomCity/js/form/element/city': 'Encomage_DropdownFields/js/form/element/city',
            'Eadesigndev_RomCity/js/form/element/region': 'Encomage_DropdownFields/js/form/element/region',
